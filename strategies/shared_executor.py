...
# ── Decision Core：以下函数已迁移至 decision/core.py（Phase 3-02） ──────
# 由顶部 from decision.core import ... re-export。
# classify_entry_mode / contract_score / short/long_signal_allows_open /
# resolve_event_flow / resolve_event_orderflow_bias /
# long_trend_takeover_ready / pump_down_uptrend_guard /
