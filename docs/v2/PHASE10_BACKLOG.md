...
| D3D Recovery Generation Fence | **IMPLEMENTED / CLOSED (DORMANT)** | operation vs canonical authority/desired exact episode+slot+protection generation decision; injected typed read coordinator; OPEN/external policy gates | pre-effect revalidation + executor composition |
