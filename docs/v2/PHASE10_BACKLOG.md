...
| Operator Decision Center | **PRODUCT REQUIREMENT APPROVED / DESIGN PLANNED** | Telegram attention + durable Web inbox; trigger/current diff; fallback countdown; secure expiring approval; dark trading-console UX | durable inbox/outbox + auth/RBAC + read API/UI before mutation integration |
