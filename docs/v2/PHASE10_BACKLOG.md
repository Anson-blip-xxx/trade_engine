...
| D3A PostgreSQL Operation Journal Foundation | **IMPLEMENTED / CLOSED (DORMANT)** | `operation_journal.model`; standalone PG schema; approved PG-stage/Redis-hot-state authority split | PG CAS adapter + lease/recovery scan + rollout QA |
